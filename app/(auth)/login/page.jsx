      ...
      xl:px-5 lg:flex-row">
        <div class="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
          ...
          <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
            ...
            relative z-10">
              <p class="w-full text-4xl font-medium  leading-snug font-serif">Account login</p>
              <div class="w-full mt-6 mr-0 mb-0 ml-0 relative space-y-8">
                ...
                <div class="relative">
                  <a class="w-full inline-block pt-2 pr-5 pb-2 pl-5 text-base font-medium text-center text-white bg-indigo-500
