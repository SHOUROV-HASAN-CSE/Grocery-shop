import Login from '../../../public/static/images/Login.jpg';
import Image from 'next/image';

const LoginPage = () => {
  return (
    <div>
      <div className='relative bg-white lg:py-10'>
        <div
      ...
      lg:flex-row xl:px-5'
        >
          <div className='flex w-full flex-col items-center pb-20 pl-10 pr-10 pt-5 lg:flex-row lg:pt-20'>
            ...
            pt-10 shadow-2xl'
              >
                <p className='w-full font-serif text-4xl  font-medium leading-snug'>
                  Account login
                </p>
                <div className='relative mb-0 ml-0 mr-0 mt-6 w-full space-y-8'>
                  ...
                  <div className='relative'>
                    <a
                      className='ease inline-block w-full rounded-lg bg-indigo-500 pb-2 pl-5 pr-5 pt-2 text-center text-base
                  ...
                  <div className='relative'>
                    <a
                      className=' ease btn btn-outline btn-primary inline-block w-full rounded-lg pb-3 pl-5 pr-5 pt-3 text-center text-base  
